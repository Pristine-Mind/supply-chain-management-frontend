    ...
    <div className="bg-gray-100 py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-gray-700 bg-white p-8 rounded-lg shadow-lg">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: "#FF9040" }}>Our Vision</h2>
          <p className="mb-6 text-lg leading-relaxed">
          ...
          <h2 className="text-2xl font-semibold mt-8 mb-4" style={{ color: "#FF9040" }}>Why Choose Mulya Bazzar?</h2>
