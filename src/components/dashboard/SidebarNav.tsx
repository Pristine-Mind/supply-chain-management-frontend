    ...
    <nav className="p-4">
      <ul className="space-y-4">
        {businessType === 'retailer' ? (
          ...
          <>
            <li><a href="/producers" className="flex items-center p-2 rounded hover:bg-green-700"><Building2 className="h-5 w-5 mr-3" />{t('producer_management')}</a></li>
            <li><a href="/retailers" className="flex items-center p-2 rounded hover:bg-green-700"><Users className="h-5 w-5 mr-3" />Retailer Management</a></li>
            <li><a href="/products" className="flex items-center p-2 rounded hover:bg-green-700"><ShoppingBag className="h-5 w-5 mr-3" />{t('product_management')}</a></li>
            ...
            <li><a href="/distribution" className="flex items-center p-2 rounded hover:bg-green-700"><Scale className="h-5 w-5 mr-3" />Distribution Management</a></li>
